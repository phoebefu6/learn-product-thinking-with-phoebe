...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#966718");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#2B3947");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#C6D2DE");   // concept border
  var C_TINT   = theme("--indigo-50", "#EEF2F6");     // concept fill
  var C_INK    = theme("--ink", "#1E2833");           // concept text
  var C_FAINT  = theme("--faint", "#CFD7E0");         // twig edges
