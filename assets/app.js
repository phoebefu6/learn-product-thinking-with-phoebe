...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = ["01-the-job-not-the-feature.html", "02-what-people-ask-for.html", "03-the-cut-bench.html", "04-order-is-a-product-decision.html", "05-saying-no-so-it-lands.html", "06-your-product-on-one-page.html"];
...
(function () {
  "use strict";
  var PASSPORT_KEY = "lwp-passport:product-thinking";
